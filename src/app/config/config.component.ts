...
export class ConfigComponent {
  public name = new FormControl("Deepgram user", [
    Validators.required,
  ]);
  public apiKey = new FormControl("", [Validators.required]);
  public speakModel = new FormControl("aura-2-thalia-en", [
    Validators.required,
  ...
  public listenModel = new FormControl("nova-3", [
    Validators.required,
    () => (control: AbstractControl) =>
      [
        "nova-3",
  ...
  public save() {
    const config: Config = {
      name: this.name.value ?? "Deepgram user",
